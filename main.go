...
func init() {
	...
	// g := flag.String("g", "127.0.0.1:6957", "Set webui url.")
	// 直接写死 AccessToken 时，请更改下面第二个参数
	token := flag.String("t", "", "Set AccessToken of WSClient.")
	// 直接写死 URL 时，请更改下面第二个参数
	url := flag.String("u", "ws://127.0.0.1:33111", "Set Url of WSClient.")
	// 默认昵称
	adana := flag.String("n", "Irori", "Set default nickname.")
